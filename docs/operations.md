...
- `deploy.sh` now fails fast if the EC2 host is not running Node 22.
- Recommended upgrade order for the host is: install Node 22, restart PM2 under Node 22, then redeploy.
